...
![Motion capture results](images/motion_capture_results.png)
*(Add a plot of accel/gyro magnitude with detected events here)*
...
![Enclosure design](images/enclosure_render.png)
*(Add a SolidWorks render/screenshot here)*
